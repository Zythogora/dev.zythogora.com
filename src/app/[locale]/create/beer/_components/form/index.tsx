...
import { createBeerAction } from "@/app/[locale]/create/beer/actions";
import { createBeerSchema } from "@/app/[locale]/create/beer/schemas";
...
const CreateBeerForm = ({ styleCategories, colors }: CreateBeerFormProps) => {
  ...
  const [lastResult, action] = useActionState(createBeerAction, undefined);
