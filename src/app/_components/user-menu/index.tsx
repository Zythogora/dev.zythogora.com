  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "hover:w-9 hover:translate-x-0 hover:translate-y-0 hover:before:h-10 hover:before:w-9.5 hover:before:translate-y-0",
        "focus-visible:w-9 focus-visible:translate-x-0 focus-visible:translate-y-0 focus-visible:before:h-10 focus-visible:before:w-9.5 focus-visible:before:translate-y-0",
        className,
      )}
      {...restProps}
    >
